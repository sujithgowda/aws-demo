...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Olb.Api*):
...
Execute unit tests
```
    cd "Olb.Api/test/Olb.Api.Tests"
    dotnet test
```

Deploy application
```
    cd "Olb.Api/src/Olb.Api"
